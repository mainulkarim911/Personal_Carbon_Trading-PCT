...
import static pct.FXML1Controller.flag_search;
 ...
 * @author Mainul Karim
 */
public class FXML_for_Credit_02Controller implements Initializable {
    ...
    private void handleButtonAction3(ActionEvent event) throws Exception {
        try {
            ...
            FXMLDocumentController.flag4=0;
            FXMLDocumentController.flag5=-1;
            FXMLDocumentController.flag6=1;
            FXMLDocumentController.i=0;
            FXMLDocumentController.j=0;
            FXMLDocumentController.m=1;
            secController.F1();
            secController.F3();
    ...
    public void F1() throws Exception {
        try {
            ...
            int x = FXMLDocumentController.flag7;
            ...
            if (flag3 == 1) {
                ...
                if(FXMLDocumentController.flag7==0){
                    F3();
                }
                else if(FXMLDocumentController.flag7==-1){
                    F4();
                }
                else if(FXMLDocumentController.flag7==1){
                    F5();
