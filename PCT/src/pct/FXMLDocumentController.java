...
public class FXMLDocumentController {
        ...
        try {
            ...
            if (flag2 == 1) {
                ...
                for (int r = 0; r < sizeofn; r++) {
                    ...
                    if (Credit == x) {
                        flag_search = 1;
                        w8.write(nid.get(r) + " ######Alhamdulillah " + phone.get(r) + " ######Alhamdulillah " + name.get(r) + " ######Alhamdulillah " + n.get(r) + " ######Alhamdulillah " + s.get(r) + " ######Alhamdulillah " + Credit + " ######Alhamdulillah " + location1.get(r) + " ######Alhamdulillah " + email.get(r) + " ######Alhamdulillah " + p.get(r) + "\n");
                    }
                }
    ...
    public ArrayList<String> location1 = new ArrayList<String>();
